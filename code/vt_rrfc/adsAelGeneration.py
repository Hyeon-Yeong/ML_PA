def createOpenAel(pathName: str,
  ...
  with open(aelPath, 'w') as f:
    ...
    #f.write('decl pin = db_create_pin(macroContext,5,80,180,db_layerid(1),1,"P1",2);\n') 
    #f.write('decl pin = db_create_pin(macroContext,645,80,0,db_layerid(1),2,"P2",2);\n')
