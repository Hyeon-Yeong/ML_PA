...
class emSim_2port_verification:
  def __init__(self, 
               workingPath: str,
               adsLibName: str,
               gdsFile: str,
  ...
  def momRun_2port(self):
    ...
    command='ads -m /home/local/millipede/hy7593/pixelatedRF_verification/'+self.libName+'_wrk/'+ aelName 
    ...
    command = 'ads -m /home/local/millipede/hy7593/pixelatedRF_verification/em_sim_automation_wrk/'+ aelCloseName
    os.system(command)
    ...
    ctiFileName='/home/local/millipede/hy7593/pixelatedRF_verification/data/spfiles/cti/' + dataSet + '.cti'
    csvFileName='/home/local/millipede/hy7593/pixelatedRF_verification/data/spfiles/csv/' + dataSet + '.csv'
