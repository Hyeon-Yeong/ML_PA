...
oEditor.ImportGDSII(
	[
		...
		"OrderMap:="		, [			"entry:="		, [				"order:="		, 0,				"layer:="		, "MET3",				"LayerNumber:="		, 20,				"Thickness:="		, 1E-06,				"Elevation:="		, 5E-06,				"Color:="		, "red", "Material:="	, "\"Au_InP\""],			"entry:="		, [				"order:="		, 1,				"layer:="		, "MET4",				"LayerNumber:="		, 23,				"Thickness:="		, 3E-06,				"Elevation:="		, 7E-06,				"Color:="		, "PINK",	"Material:="	,"\"Au_InP\""]]
	])
