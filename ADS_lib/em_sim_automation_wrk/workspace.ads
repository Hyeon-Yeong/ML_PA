<ADSWorkspace Revision="10" Version="100">
    <Workspace Name="">
        ...
        <Library Name="em_sim_automation_lib" />
        <Cell Name="em_sim_automation_lib:cell_1" />
        <Log Name="readgds.log" />
        <Log Name="search_history.log" />
        <Substrate Name="em_sim_automation_lib:substrate1.subst" />
        <Cell Name="em_sim_automation_lib:RANDOM" />
        <Preferences Name="em_sim_automation_lib_lay.prf" />
        <Preferences Name="em_sim_automation_lib_sch.prf" />
        <Log Name="oaStrm.log" />
        <Dataset Name="RANDOM_MomUW.ds" />
        <Data_Files Name="RANDOM_MomUW.ds" />
    </Workspace>
</ADSWorkspace>
